...
**Submittable:** yes   **Tree:** no   **Naming:** `format:HR-PF-{YYYY}-{#####}` (e.g. `HR-PF-2026-00001`)
**Module:** HR
...
| employee | For Employee | Link | Employee | yes | — | — | in_list_view, in_standard_filter — the employee being reviewed |
...
| reviewer | Reviewer | Link | Employee | yes | — | — | `ignore_user_permissions: 1`; in_standard_filter — the employee giving feedback |
